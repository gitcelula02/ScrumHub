      ...
      <div className="w-full max-w-[400px] bg-sidebar-bg border border-panel-border rounded-sm shadow-2xl p-8">
        <div className="flex flex-col items-center mb-8 text-center">
          ...
          <h1 className="text-xl font-bold text-foreground">
            Bienvenido a ScrumHub
          </h1>
          <p className="text-sm text-muted-foreground mt-1">
            Gestión ágil estilo VS Code
          </p>
        </div>
        ...
        <div className="relative my-8">
          ...
          <div className="relative flex justify-center text-[11px] uppercase">
            <span className="bg-sidebar-bg px-2 text-muted-foreground">
              O continuar con
            </span>
          </div>
        </div>
        ...
        <Button
          variant="outline"
          className="w-full border-panel-border hover:bg-list-hover gap-2 text-foreground"
        >
        ...
        <p className="mt-8 text-center text-xs text-muted-foreground">
          ...
          <Link
            to="/register"
            className="text-status-bar hover:underline font-semibold"
          >
            Regístrate aquí
          </Link>
        </p>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-editor p-4 text-foreground">
      <div className="w-full max-w-[400px] text-center">
        <h1 className="text-2xl font-bold mb-4 text-status-bar">
          Próximamente
        </h1>
        <p className="text-muted-foreground mb-8">
          Estamos construyendo el futuro de la gestión ágil.
        </p>
