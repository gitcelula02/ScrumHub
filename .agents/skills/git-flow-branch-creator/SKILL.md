...
<validation>
	<pre-analysis>
		...
		<check>Current branch is appropriate starting point (develop for features/releases, main for hotfixes)</check>
	...
	<execution-safety>
		<check>Target branch (develop/main) exists and is accessible</check>
...
<gitflow-reference>
	<main-branches>
		<main>Production-ready code, every commit is a release</main>
	...
	<supporting-branches>
		...
		<release>Branch from develop, merge to both develop and main</release>
		<hotfix>Branch from main, merge to both develop and main</hotfix>
	</supporting-branches>

	<merge-strategy>
		<flag>Always use --no-ff flag to preserve branch history</flag>
		<tagging>Tag releases on main branch</tagging>
